...
$selectionTypes = ['multiple', 'single', 'quantity'];
?>
<section class="admin-panel">
    <div class="admin-panel-header">
        <?php admin_render_create_header('Create Service', 'Add a priced option that can be attached to bookings.', 'create-service-form', 'Create service'); ?>
    </div>
...
<section class="admin-panel mt-5" data-sort-panel>
    ...
    <div class="overflow-x-auto">
        <table id="services-table" class="admin-table min-w-[1200px]" data-sortable-table>
            <thead>
                <tr><th class="px-4 py-3">ID</th><th class="px-4 py-3">Category</th><th class="px-4 py-3">Code</th><th class="px-4 py-3">Name</th><th class="px-4 py-3">Price</th><th class="px-4 py-3">Type</th><th class="px-4 py-3">Sort</th><th class="px-4 py-3">Active</th><th class="px-4 py-3">Created At</th><th class="px-4 py-3">Updated At</th><th class="px-4 py-3">Actions</th></tr>
            </thead>
