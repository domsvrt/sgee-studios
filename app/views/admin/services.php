...
<section class="admin-panel mt-5">
    <div class="admin-panel-header"><h3 class="admin-panel-title">Services</h3><p class="admin-panel-subtitle"><?= $e(count($services)) ?> priced booking options</p></div>
            ...
            <tbody>
                <?php foreach ($services as $service): ?>
                    <tr>
                        ...
                        <td class="px-4 py-3"><input data-edit-field disabled form="service-<?= $e($service['id']) ?>" type="number" name="sort_order" value="<?= $e($service['sort_order']) ?>" class="<?= $fieldSm ?> max-w-24"></td>
