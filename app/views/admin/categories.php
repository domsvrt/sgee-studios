...
<section class="admin-panel">
    ...
    <form id="create-category-form" method="post" action="/admin/categories/create" class="hidden grid gap-3 p-5 md:grid-cols-5">
        ...
        <button class="btn-primary md:col-span-4">Create category</button>
    </form>
</section>
        ...
        <table class="admin-table min-w-[900px]">
            ...
            <tbody>
                <?php foreach ($categories as $category): ?>
                    <tr>
                        <td class="px-4 py-3"><input data-edit-field disabled form="category-<?= $e($category['id']) ?>" name="slug" value="<?= $e($category['slug']) ?>" class="<?= $fieldSm ?>"></td>
